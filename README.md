...
This script uses all OmegaPlus output files for the simulated data and plots a distribution in order to extract the 99th percentile for threshold determination.
